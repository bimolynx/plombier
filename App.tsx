      ...
      <section id="top" className="relative min-h-[85vh] flex items-center pt-10 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="max-w-2xl animate-in slide-in-from-left-8 duration-700">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-light-500 text-black-700 rounded-full text-sm font-semibold mb-6 border border-black-100">
              <span className="flex h-2 w-2 rounded-full bg-black-600 animate-pulse"></span>
